# -*- coding: utf-8 -*-
"""
Created on Sat Mar 14 21:48:34 2020
...
class E2E_CUBDataSet(Dataset):
    def __init__(self, data_path, is_scale = False, is_unsupervised_attr = False,is_balance =True, split = "train", is_augment = True,is_normalize_att=False):
        ...
        self.is_normalize_att = is_normalize_att
        
        if self.is_normalize_att:
            print("Use normalize att")
