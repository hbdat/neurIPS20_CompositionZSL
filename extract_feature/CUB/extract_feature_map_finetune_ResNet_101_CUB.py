...
#%%
model_path = save_NFS+'results/CUB_DAZLE_finetuning/DAZLE_checkpoint_phase_2_ResNet.pt'

img_dir = os.path.join(NFS_path_AoA,'data/CUB/')
file_paths = os.path.join(NFS_path_AoA,'data/xlsa17/data/CUB/res101.mat')
save_path = os.path.join(NFS_path,'data/CUB/feature_map_ResNet_101_{}.hdf5'.format("CUB_finetune"))
