...
#%%
model_path = save_NFS+'results/DeepFashion_DAZLE_finetuning/DAZLE_checkpoint_phase_2_ResNet.pt'

img_dir = os.path.join(NFS_path_AoA,'data/{}/'.format(dataset))
file_paths = os.path.join(NFS_path_AoA,'data/{}/annotation.pkl'.format(dataset))
save_path = os.path.join(NFS_path,'data/{}/feature_map_ResNet_101_{}_sep_seen_samples.hdf5'.format(dataset,"DeepFashion_finetune"))
