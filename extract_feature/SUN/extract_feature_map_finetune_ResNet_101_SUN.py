...
#%%
model_path = save_NFS+'results/SUN_DAZLE_finetuning/DAZLE_checkpoint_phase_2_ResNet.pt'
...
save_path = os.path.join(save_NFS,'data/{}/feature_map_ResNet_101_{}.hdf5'.format(dataset,"SUN_finetune"))     #share path with the old project
