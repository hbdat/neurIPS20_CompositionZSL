...
#%%
model_path = save_NFS+'results/AWA2_DAZLE_finetuning/DAZLE_checkpoint_phase_2_ResNet.pt'
...
save_path = os.path.join(NFS_path,'data/{}/feature_map_ResNet_101_{}.hdf5'.format(dataset,"AWA2_finetune"))
