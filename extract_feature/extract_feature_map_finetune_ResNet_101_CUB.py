# -*- coding: utf-8 -*-
"""
Created on Thu Apr  2 10:50:27 2020
...
import pickle
from global_setting_Pegasus import NFS_path_AoA,save_NFS,NFS_path
...
#%%
model_path = "./pretrained/CUB/feature_extractor.pth"#save_NFS+'results/CUB_DAZLE_finetuning/DAZLE_checkpoint_finetune_scheduler.pt'
model_name = model_path.split("/")[-1].split('.')[0]

img_dir = os.path.join(NFS_path_AoA,'data/CUB/')
file_paths = os.path.join(NFS_path_AoA,'data/xlsa17/data/CUB/res101.mat')
save_path = os.path.join(NFS_path,'data/CUB/feature_map_{}.hdf5'.format(model_name))
...
model_f.load_state_dict(torch.load(model_path,map_location=device))
...
#%%
input_size = 224
data_transforms = data_transforms['deterministic']
...
split_path = os.path.join(NFS_path_AoA,'data/xlsa17/data/CUB/att_splits.mat')
